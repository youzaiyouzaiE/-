...
- (void)loadData
{
    ...
    //http://59.110.23.172/api/articles/channel/6
    //NSString *allUrlstring = [NSString stringWithFormat:@"/nc/article/%@/0-20.html",self.urlString];
    NSString *allUrlstring = [NSString stringWithFormat:@"api/articles/channel/6"];
...
- (void)loadDataForType:(int)type withURL:(NSString *)allUrlstring
{
    [[[SXNetworkTools sharedNetworkTools] GET:allUrlstring parameters:nil progress:nil success:^(NSURLSessionDataTask *task, NSDictionary* responseObject) {
        ...
        NSArray *arrayM = [TWNewsEntity mj_objectArrayWithKeyValuesArray:temArray];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TWNewsEntity *NewsModel = self.arrayList[indexPath.row];
    if (NewsModel.hasHead && NewsModel.photosetID) {
        ...
        [cell.imgIcon sd_setImageWithURL:[NSURL URLWithString:NewsModel.cover_pic] placeholderImage:[UIImage imageNamed:@"302"]];
        ...
        cell.imageUrls = [NSArray arrayWithObjects:NewsModel.cover_pic, NewsModel.imgextra[0], NewsModel.imgextra[0], nil];
        return cell;
    }else{
        SinglePictureNewsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:singlePictureCell];
        cell.imageUrl = NewsModel.cover_pic;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (NewsModel.hasHead && NewsModel.photosetID) {
        ...
        viewController.imageUrls =  [NSArray arrayWithObjects:NewsModel.cover_pic, NewsModel.imgextra[0], NewsModel.imgextra[0], nil];
