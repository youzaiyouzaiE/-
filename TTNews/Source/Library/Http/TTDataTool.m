...
+(void)videoWithParameters:(TTVideoFetchDataParameter *)videoParameters success:(void (^)(NSArray *array, NSString *maxtime))success failure:(void (^)(NSError *error))failure {
    ...
    [[TTNetworkSessionManager shareManager] Get:@"http://api.budejie.com/api/api_open.php" Parameters:parameters Success:^(NSURLSessionDataTask *task, id responseObject) {
...
+(void)TTNormalNewsWithParameters:(TTNormalNewsFetchDataParameter *)normalNewsParameters success:(void (^)(NSMutableArray *array))success failure:(void (^)(NSError *error))failure {
    ...
    [[TTNetworkSessionManager shareManager] Get2:@"http://apis.baidu.com/showapi_open_bus/channel_news/search_news" Parameters:parameters Success:^(NSURLSessionDataTask *task, NSDictionary *responseObject) {
